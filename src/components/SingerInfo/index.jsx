...
const UserInfo = ({ playListData, theme, onAddPlayList, onRemovePlayList, currentUser, onNavigateArtist, onPlaySong }) => {
      ...
      <div className={cx('info-artists')}>
        ...
        <div className={cx('artists')}>
          {playListData?.artists?.map(({ name, id, link }, index) => (
            <span key={id} onClick={() => onNavigateArtist(null, path.DETAILS_ARTIST.replace('/:name', link))}>
